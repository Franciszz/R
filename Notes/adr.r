...
file.copy(paste(paste(dir_t$des, "Report/研究报告", sep = "/"), fileNames, sep = "/"), 
    dir_t$f2017)

# base包中的所有函数列衐�<U+3E38>
...
# setMethod()则需要将泛型函数的名称、方法应该关联的类别以及一个实现该函数的方�<U+393C><U+3E35>
# 转换原有函数
getGeneric
setGeneric("union")
...
## 最优化optim()(Rvmmin�<85>) 就地修改-递归函数-while循环不适宜泛函
...
# explanation:delay by 1 second, print a dot every 10 invocations. 备忘�<U+393C><U+3E35>
library(memoise)
...
## 非标准计�<U+393C><U+3E37>(在指定数据框内运�<U+383C><U+3E63>)quote&eval
...
# 现在我们检查一下它能不能工�<U+393C><U+3E63>
escape("This is some text.")
# > <HTML> This is some text.
escape("x > 1 & y < 2")
# > <HTML> x &gt; 1 &amp; y &lt; 2 两层转义也没问题
escape(escape("This is some text. 1 > 2"))
# > <HTML> This is some text. 1 &gt; 2 我们知道的HTML 文本不会被转义�<U+383C><U+3E32>
escape(html("<hr />"))
# > <HTML> <hr />
